...
1. 点击屏幕**左上角**的 **Watchlist** 菜单图标 ![Watchlist 菜单图标](resources/images/watchlist-icon.png){ width=54 height=51 }（带表头的小图标）。
2. 在弹出的列表左**上角**点击 **+** 号。

    ![Watchlist 弹窗顶部的 + 号](resources/images/watchlists.png "Watchlist Add Button")
3. 在弹窗底部选择 **New Watchlist**（新建自选列表）。

    ![New Watchlist 按钮](resources/images/watchlists1.png "Add a New Watchlist")
4. 进入空表后，再次点击 **+** 号即可开始添加合约。

    ![空表内点击 + 添加合约](resources/images/watchlists2.png "Add Instruments to Watchlist")
...
3. 从下拉列表中选择要交易的合约。
    ...
    ![从资产类型下拉中选择合约](resources/images/watchlists3.png "Add an Instrument to a Watchlist")
4. 选中的合约被加入到自选列表。
...
2. 选择所需的视图类型。
    ...
    ![Watchlist 视图下拉菜单](resources/images/watchlists4.png "Watchlist View")
3. 选择 **Create New View** 时，会出现**可用列**（Available Columns）面板。

    ![Create New View 的可用列面板](resources/images/watchlists5.png "Create a New View")
...
- [行情详情（Quote Details）](https://www.ibkrguides.com/ibkrdesktop/quote-details.htm)（源站链接）
