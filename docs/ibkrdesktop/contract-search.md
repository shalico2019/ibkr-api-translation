...
1. **打开搜索框**：在 IBKR Desktop 主界面**左上角的搜索框**中点击，弹出合约搜索面板（一个浮层或弹窗）。
    ...
    ![合约搜索面板（The contract search on the IBKR desktop）](resources/images/contract-search.png)
...
5. **打开目标产品**：在搜索结果中**点击**你感兴趣的产品，IBKR Desktop 会弹出该产品的报价窗口（含图表）。
    ...
    ![IBKR Desktop 标的详情窗口（The IBKR Desktop instrument details）](resources/images/contract-search2.png)
...
!!! note "界面位置"
    ...
    （合约搜索面板与标的详情窗口图示已分别嵌入上方"操作步骤"第 1 步与第 5 步。）
