...
1. **打开筛选器面板**：在 IBKR Desktop 主界面**左侧导航栏**点击 **Screeners** 图标（漏斗形状的图标），筛选器窗口打开。
    ...
    > 界面位置：左下角（紧邻 Portfolio / Watchlist 图标）。
...
- 源站最后更新日期：2025-10-07
- 截图：源站含 2 张截图（筛选器参数窗口 / My Screeners 标签页），均为 IBKR Desktop 官方 UI 截图；本译本以文字描述替代。
